...
<body>
	...
	<?php
        ...
        $toAddress = "alohaaustin7@gmail.com";  //place your/your client's email address here
        $toName = "Chandler Spears"; //place your client's name here
        $website = "CB Designs";  //place NAME of your client's website
